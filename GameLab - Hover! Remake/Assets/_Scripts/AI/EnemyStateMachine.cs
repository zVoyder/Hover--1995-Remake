...
using ExtensionMethods.GameoObjectFinders;
...
/// The AI has three states: CHASE, GRABFLAG, and PATROL.
/// The AI will chase the player if they are within a certain range,
/// grab a flag if one is within range, and patrol randomly if neither of those conditions are met.
...
public class EnemyStateMachine : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _player = GameObject.FindGameObjectWithTag("Player").transform; // find the player in the scene
    ...
    private void Update()
    {
        ...
        {
            // Check if there is a flag within range
            ...
            {
                // If so, set the closest flag as the target and set the state to GRABFLAG
    ...
    /// <summary>
    /// Set the destination to the position of the closest flag
    /// </summary>
